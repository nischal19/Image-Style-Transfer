...
def build_parser():
    ...
    parser.add_argument('--prev_content',
            dest='prev_content', help='previous content image',
            metavar='PREV_CONTENT', required=True)
    parser.add_argument('--prev_style',
            dest='prev_style', help='previous style image',
            metavar='PREV_STYLE', required=True)
...
def main():
    ...
    prev_content_image = imread(options.prev_content)
    prev_style_image = imread(options.prev_style)
